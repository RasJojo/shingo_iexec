    ...
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-4 pb-20 pt-10 sm:px-6 lg:px-8">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="space-y-2">
          <h2 className="font-display text-3xl font-semibold tracking-tight text-gray-950 dark:text-white sm:text-5xl">
            Creator Studio
          </h2>
      ...
      <div className="grid gap-6 lg:grid-cols-[1.25fr_0.75fr]">
        <Card className="glass-panel border-violet-300/20">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 font-display text-2xl text-gray-950 dark:text-white">
          ...
          <CardContent className="space-y-5">
              ...
              <form className="space-y-3 rounded-xl border border-amber-300/35 bg-amber-400/10 p-4" onSubmit={registerTrader}>
                ...
                <div>
                  ...
                  <Input
                    ...
                    className="mt-2 border-amber-200/30 bg-white dark:bg-white dark:bg-slate-950/80"
                  />
                </div>
                <Button
                  type="submit"
            ...
            {isTrader && (
              <>
                <form className="space-y-3 rounded-xl border border-slate-200 dark:border-slate-300 dark:border-white/10 bg-white/90 dark:bg-white/90 dark:bg-slate-950/70 p-4" onSubmit={openSeason}>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className="mt-2 border-slate-200 dark:border-slate-300 dark:border-white/10 bg-white dark:bg-white dark:bg-slate-900/80"
                    />
                  </div>
                  <Button
                    type="submit"
                ...
                <form className="space-y-3 rounded-xl border border-slate-200 dark:border-slate-300 dark:border-white/10 bg-white/90 dark:bg-white/90 dark:bg-slate-950/70 p-4" onSubmit={publishSignal}>
                  <p className="text-sm text-gray-800 dark:text-slate-200">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      readOnly
                      className="mt-2 border-slate-200 dark:border-slate-300 dark:border-white/10 bg-white dark:bg-white dark:bg-slate-900/60 text-gray-600 dark:text-slate-400"
                    />
                  </div>
                  <div className="grid gap-3 md:grid-cols-2">
                    <div>
                      ...
                      <Select value={market} onValueChange={setMarket}>
                        <SelectTrigger id="signalMarket" className="mt-2 border-slate-200 dark:border-slate-300 dark:border-white/10 bg-white dark:bg-white dark:bg-slate-900/80">
                    ...
                    <div>
                      ...
                      <Select value={side} onValueChange={setSide}>
                        <SelectTrigger id="signalSide" className="mt-2 border-slate-200 dark:border-slate-300 dark:border-white/10 bg-white dark:bg-white dark:bg-slate-900/80">
                    ...
                    <div>
                      ...
                      <Select value={entryKind} onValueChange={setEntryKind}>
                        <SelectTrigger id="signalEntryType" className="mt-2 border-slate-200 dark:border-slate-300 dark:border-white/10 bg-white dark:bg-white dark:bg-slate-900/80">
                  ...
                  <div className="grid gap-3 md:grid-cols-3">
                    ...
                    <div>
                      ...
                      <Select value={venue} onValueChange={setVenue}>
                        <SelectTrigger id="signalVenue" className="mt-2 border-slate-200 dark:border-slate-300 dark:border-white/10 bg-white dark:bg-white dark:bg-slate-900/80">
                    ...
                    <div>
                      ...
                      <Select value={timeframe} onValueChange={setTimeframe}>
                        <SelectTrigger id="signalTimeframe" className="mt-2 border-slate-200 dark:border-slate-300 dark:border-white/10 bg-white dark:bg-white dark:bg-slate-900/80">
        ...
        <div className="space-y-6">
          <Card className="glass-panel border-slate-200 dark:border-slate-300 dark:border-white/10">
            <CardHeader>
              <CardTitle className="font-display text-xl text-gray-950 dark:text-white">Status</CardTitle>
              <CardDescription>Live state from ShingoHub.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3 text-sm">
              <div className="flex items-center justify-between rounded-lg border border-slate-200 dark:border-slate-300 dark:border-white/10 bg-white/90 dark:bg-white/90 dark:bg-slate-950/70 p-3">
                <span className="text-gray-700 dark:text-slate-300">Wallet</span>
                <span className="font-mono text-gray-900 dark:text-slate-100">
                  {address ? `${address.slice(0, 6)}...${address.slice(-4)}` : "Not connected"}
                </span>
              </div>
              <div className="flex items-center justify-between rounded-lg border border-slate-200 dark:border-slate-300 dark:border-white/10 bg-white/90 dark:bg-white/90 dark:bg-slate-950/70 p-3">
                <span className="text-gray-700 dark:text-slate-300">Trader profile</span>
                <span className="font-mono text-gray-900 dark:text-slate-100">{loading ? "loading..." : isTrader ? "active" : "missing"}</span>
              </div>
              {isTrader && (
                <>
                  <div className="flex items-center justify-between rounded-lg border border-slate-200 dark:border-slate-300 dark:border-white/10 bg-white/90 dark:bg-white/90 dark:bg-slate-950/70 p-3">
                    <span className="text-gray-700 dark:text-slate-300">Pseudo</span>
                    <span className="font-mono text-gray-900 dark:text-slate-100">{traderPseudo}</span>
                  </div>
                  <div className="flex items-center justify-between rounded-lg border border-slate-200 dark:border-slate-300 dark:border-white/10 bg-white/90 dark:bg-white/90 dark:bg-slate-950/70 p-3">
                    <span className="text-gray-700 dark:text-slate-300">Current season</span>
                    <span className="font-mono text-gray-900 dark:text-slate-100">
                      {currentSeasonId > 0n ? `#${currentSeasonId.toString()}` : "none"}
                    </span>
                  </div>
                  <div className="flex items-center justify-between rounded-lg border border-slate-200 dark:border-slate-300 dark:border-white/10 bg-white/90 dark:bg-white/90 dark:bg-slate-950/70 p-3">
                    <span className="text-gray-700 dark:text-slate-300">Season status</span>
                    <span className="font-mono text-gray-900 dark:text-slate-100">{currentSeasonStatus}</span>
                  </div>
                  <div className="flex items-center justify-between rounded-lg border border-slate-200 dark:border-slate-300 dark:border-white/10 bg-white/90 dark:bg-white/90 dark:bg-slate-950/70 p-3">
                    <span className="text-gray-700 dark:text-slate-300">Price</span>
                    <span className="font-mono text-gray-900 dark:text-slate-100">{currentSeasonPriceDisplay}</span>
                  </div>
                  <div className="flex items-center justify-between rounded-lg border border-slate-200 dark:border-slate-300 dark:border-white/10 bg-white/90 dark:bg-white/90 dark:bg-slate-950/70 p-3">
                    <span className="text-gray-700 dark:text-slate-300">Signals in season</span>
                    <span className="font-mono text-gray-900 dark:text-slate-100">{currentSeasonSignals.toString()}</span>
                  </div>
                </>
              )}
            </CardContent>
          ...
          <Card className="glass-panel border-slate-200 dark:border-slate-300 dark:border-white/10">
            <CardHeader>
              <CardTitle className="font-display text-xl text-gray-950 dark:text-white">Flow checklist</CardTitle>
          ...
          <Card className="glass-panel border-slate-200 dark:border-slate-300 dark:border-white/10">
            <CardContent className="space-y-2 p-4 text-sm">
              <p className="text-gray-700 dark:text-slate-300">Contract explorer</p>
              <a
